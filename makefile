...
FRAMEWORK_SOURCES_CPP := 	framework/framework.cpp \
							...
							framework/automaton/AutomatonFullyConnected.cpp \
							framework/automaton/AutomatonNodeBase.cpp \
							framework/automaton/AutomatonNodeDirected.cpp \
							framework/automaton/AutomatonNodeFullyConnected.cpp \
...
framework_binary:
	@$(MAKEFILE_BUILDER) $(MAKEFLAGS) CPP_TO_COMPILE="$(FRAMEWORK_SOURCES_CPP)" EXE_TARGET="framework.exe"
...
module_tcpsocket:
	@$(MAKEFILE_BUILDER) $(MAKEFLAGS) CPP_TO_COMPILE="$(MODULE_TCP_SOURCES_CPP)" EXE_TARGET="TCPSocket.dll" BUILD_AS_DLL="yes"

module_connection:
	@$(MAKEFILE_BUILDER) $(MAKEFLAGS) CPP_TO_COMPILE="$(MODULE_CONNECTION_CPP)" EXE_TARGET="Connection.dll" BUILD_AS_DLL="yes"
